package org.think2framework.wechat.exception;
...
public class WechatErrorException extends RuntimeException {
	...
	public WechatErrorException(String errCode) {
		super(getMessage(errCode));
		this.errCode = errCode;
	}

	public WechatErrorException(String errCode, Throwable cause) {
		super(getMessage(errCode), cause);
		this.errCode = errCode;
	}

	protected WechatErrorException(String errCode, Throwable cause, boolean enableSuppression,
	...
	private static String getMessage(String code) {
		switch (code) {
			...
			case "48004" :
				return "api接口被封禁，请登录mp.wechat.qq.com查看详情";
			case "48005" :
